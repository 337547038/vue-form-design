/* empty css                                                            */import{o as e,c as n,af as o}from"./index-792ff79a.js";const s={class:"marked-body"},c=o(`<h1 id="开发指南">开发指南</h1><p>欢迎有兴趣的同学参与完善文档</p><h2 id="目录结构">目录结构</h2><pre class="language-text"><code class="hljs">nodejs 模拟后端接口
public
 ├─mock 模拟数据
 ├─static 静态资源
   ├─ iconfont icon图标
