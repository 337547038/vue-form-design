import{U as e,V as t,_ as n,bt as r,d as i,f as a,ft as o,i as s,m as c,nt as l,v as u,y as d,z as f}from"./runtime-core.esm-bundler-DxlV0Puh.js";import{t as p}from"./component-CNiqdUll.js";var m={__name:`form-option.md.Virtual1954f7e5`,setup(t){let n=o({list:[{type:`inputSlot`,control:{modelValue:``,teleported:!0,style:{width:`100px`}},options:[{label:`选项1`,value:`1`}],optionsType:0,name:`select1`,formItem:{label:`下拉选择框`}},{type:`input`,control:{modelValue:``},append:`key:select1`,name:`text`,formItem:{label:`单行文本`}}],config:{submitCancel:!1}});return(t,r)=>{let i=e(`ak-form`);return f(),a(i,{data:n.value},null,8,[`data`])}}},h={__name:`form-option.md.Virtualc64f9dc0`,setup(n){let r=o(`1`),i=[{label:`选项1`,value:1}];return(n,o)=>{let u=e(`el-option`),p=e(`el-select`),m=e(`el-form-item`);return f(),a(m,{label:`此时无法正常回显`},{default:l(()=>[d(p,{modelValue:r.value,"onUpdate:modelValue":o[0]||=e=>r.value=e},{default:l(()=>[(f(),c(s,null,t(i,e=>d(u,{value:e.value,label:e.label},null,8,[`value`,`label`])),64))]),_:1},8,[`modelValue`])]),_:1})}}},g={__name:`form-option.md.Virtual03b394f5`,setup(t){let n=o({list:[{type:`input`,control:{modelValue:``,placeholder:`值发生改变时，下拉选择框会重新发起请求`},name:`name1`,formItem:{label:`单行文本`}},{type:`select`,control:{modelValue:``,teleported:!0,remote:!1,filterable:!1},label:`name`,options:[],optionsType:1,optionsFun:`demo/select`,method:`get`,linkage:`name1`,before:(e,{type:t,route:n,model:r})=>(console.log(t),e),after:(e,t,n)=>(console.log(n,e),e),name:`select1`,formItem:{label:`下拉选择框`}}],config:{submitCancel:!1}});return(t,r)=>{let i=e(`ak-form`);return f(),a(i,{data:n.value},null,8,[`data`])}}},_={__name:`form-option.md.Virtualf3356f34`,setup(t){let n=o({list:[{type:`input`,control:{modelValue:``},name:`password`,formItem:{label:`密码`},customRules:[{type:`required`,message:`必填项`,trigger:`blur`}]},{type:`input`,control:{modelValue:``},name:`password2`,formItem:{label:`确认密码`,rules:[{validator:(e,t,n)=>{t===``?n(Error(`请输入确认密码`)):(getform1ValueByName(`password`)===t&&n(),n(Error(`两次密码输入不一致`)))},trigger:`blur`}]},customRules:[{type:`required`,message:`必填项`,trigger:`blur`}]}],config:{submitUrl:`demo/select`,key:`form1`,submitCancel:!0}});return(t,r)=>{let i=e(`ak-form`);return f(),a(i,{data:n.value},null,8,[`data`])}}},v={class:`marked-body`},y={__name:`form-option`,setup(e){return(e,t)=>(f(),c(`div`,v,[t[4]||=n(`<h1 id="ak-form 配置手册"><a name="ak-form-" class="anchor" href="#ak-form-"><span class="header-link"></span></a> ak-form 配置手册 </h1><p>配置数据由表单设计器通过拖拽添加相应组件及填写对应字段配置自动生成。脱离表单设计器时可按此数据格式要求，直接使用<code>ak-form</code> 表单，即<code>ak-form</code>表单组件可不依懒于表单设计器工作。</p><h2 id="一些表单配置说明"><a name="-" class="anchor" href="#-"><span class="header-link"></span></a> 一些表单配置说明 </h2><h3 id="- 快速添加确定取消按钮"><a name="-" class="anchor" href="#-"><span class="header-link"></span></a> - 快速添加确定取消按钮 </h3><p><code>config.submitCancel</code></p><ul><li>类型：boolean/string[]</li></ul><p>快速添加表单提交和取消按钮。设置为<code>true</code>可快速显示<code>确定</code>和<code>取消</code>两个按钮，如其他可自定义，格式为</p><pre class="language-javascript"><code class="hljs"><span class="hljs-keyword">const</span> submitCancel = [
  {
    ...
    `),i(`span`,{class:`hljs-attr`},`list`),u(`: [
      {
        ...
        `),i(`span`,{class:`hljs-attr`},`control`),u(`:
          {
            `),i(`span`,{class:`hljs-attr`},`modelValue`),u(`: `),i(`span`,{class:`hljs-string`},`""`),u(`,
            `),i(`span`,{class:`hljs-attr`},`placeholder`),u(`: `),i(`span`,{class:`hljs-string`},`'值发生改变时，下拉选择框会重新发起请求'`),u(`
          },
        `),i(`span`,{class:`hljs-attr`},`name`),u(`: `),i(`span`,{class:`hljs-string`},`"name1"`),u(`,
        `),i(`span`,{class:`hljs-attr`},`formItem`),u(`:
          {
            `),i(`span`,{class:`hljs-attr`},`label`),u(`: `),i(`span`,{class:`hljs-string`},`"单行文本"`),u(`
          }
      ...
      {
        `),i(`span`,{class:`hljs-attr`},`type`),u(`: `),i(`span`,{class:`hljs-string`},`"select"`),u(`,
        `),i(`span`,{class:`hljs-attr`},`control`),u(`:
          {
            `),i(`span`,{class:`hljs-attr`},`modelValue`),u(`: `),i(`span`,{class:`hljs-string`},`""`),u(`,
            `),i(`span`,{class:`hljs-attr`},`teleported`),u(`: `),i(`span`,{class:`hljs-literal`},`true`),u(`,
            `),i(`span`,{class:`hljs-attr`},`remote`),u(`: `),i(`span`,{class:`hljs-literal`},`false`),u(`,
            `),i(`span`,{class:`hljs-attr`},`filterable`),u(`: `),i(`span`,{class:`hljs-literal`},`false`),u(`,
          },
        `),i(`span`,{class:`hljs-attr`},`label`),u(`:`),i(`span`,{class:`hljs-string`},`'name'`),u(`,
        `),i(`span`,{class:`hljs-attr`},`options`),u(`: [],
        `),i(`span`,{class:`hljs-attr`},`optionsType`),u(`: `),i(`span`,{class:`hljs-number`},`1`),u(`,
        `),i(`span`,{class:`hljs-attr`},`optionsFun`),u(`: `),i(`span`,{class:`hljs-string`},`"demo/select"`),u(`,
        `),i(`span`,{class:`hljs-attr`},`method`),u(`: `),i(`span`,{class:`hljs-string`},`"get"`),u(`,
        `),i(`span`,{class:`hljs-attr`},`linkage`),u(`: `),i(`span`,{class:`hljs-string`},`"name1"`),u(`, `),i(`span`,{class:`hljs-comment`},`// 关联前面的单行文本name=input1的组件`),u(`
        `),i(`span`,{class:`hljs-attr`},`before`),u(`: `),i(`span`,{class:`hljs-function`},[u(`(`),i(`span`,{class:`hljs-params`},`params, {type, route, model}`),u(`) =>`)]),u(` {
          `),i(`span`,{class:`hljs-comment`},`// 当由name1发生改变触发的请求时，此时type=linkage`),u(`
          `),i(`span`,{class:`hljs-variable language_`},`console`),u(`.`),i(`span`,{class:`hljs-title function_`},`log`),u(`(type)
          `),i(`span`,{class:`hljs-keyword`},`return`),u(` params
        },
        `),i(`span`,{class:`hljs-attr`},`after`),u(`: `),i(`span`,{class:`hljs-function`},[u(`(`),i(`span`,{class:`hljs-params`},`res, success, type`),u(`) =>`)]),u(` {
          `),i(`span`,{class:`hljs-comment`},`// res接口返回结果，type当前事件类型，success是否成功；对结果修改后返回`),u(`
          `),i(`span`,{class:`hljs-variable language_`},`console`),u(`.`),i(`span`,{class:`hljs-title function_`},`log`),u(`(type, res)
          `),i(`span`,{class:`hljs-keyword`},`return`),u(` res
        },
        `),i(`span`,{class:`hljs-attr`},`name`),u(`: `),i(`span`,{class:`hljs-string`},`"select1"`),u(`,
        `),i(`span`,{class:`hljs-attr`},`formItem`),u(`:
          {
    ...
    `),i(`span`,{class:`hljs-attr`},`list`),u(`: [
      {
        ...
        `),i(`span`,{class:`hljs-attr`},`name`),u(`: `),i(`span`,{class:`hljs-string`},`"password"`),u(`,
        `),i(`span`,{class:`hljs-attr`},`formItem`),u(`:
                {
                  `),i(`span`,{class:`hljs-attr`},`label`),u(`: `),i(`span`,{class:`hljs-string`},`"密码"`),u(`
                },
        `),i(`span`,{class:`hljs-attr`},`customRules`),u(`: [
          {
            `),i(`span`,{class:`hljs-attr`},`type`),u(`: `),i(`span`,{class:`hljs-string`},`"required"`),u(`,
            `),i(`span`,{class:`hljs-attr`},`message`),u(`: `),i(`span`,{class:`hljs-string`},`"必填项"`),u(`,
            `),i(`span`,{class:`hljs-attr`},`trigger`),u(`: `),i(`span`,{class:`hljs-string`},`"blur"`),u(`
          }]
      },
      {
        `),i(`span`,{class:`hljs-attr`},`type`),u(`: `),i(`span`,{class:`hljs-string`},`"input"`),u(`,
        ...
        `),i(`span`,{class:`hljs-attr`},`name`),u(`: `),i(`span`,{class:`hljs-string`},`"password2"`),u(`,
        `),i(`span`,{class:`hljs-attr`},`formItem`),u(`:
                {
                  `),i(`span`,{class:`hljs-attr`},`label`),u(`: `),i(`span`,{class:`hljs-string`},`"确认密码"`),u(`,
                  `),i(`span`,{class:`hljs-attr`},`rules`),u(`: [
                    {
                      `),i(`span`,{class:`hljs-attr`},`validator`),u(`: `),i(`span`,{class:`hljs-function`},[u(`(`),i(`span`,{class:`hljs-params`},`rule, value, callback`),u(`) =>`)]),u(` {
                        `),i(`span`,{class:`hljs-keyword`},`if`),u(` (value === `),i(`span`,{class:`hljs-string`},`''`),u(`) {
                          `),i(`span`,{class:`hljs-title function_`},`callback`),u(`(`),i(`span`,{class:`hljs-keyword`},`new`),u(),i(`span`,{class:`hljs-title class_`},`Error`),u(`(`),i(`span`,{class:`hljs-string`},`'请输入确认密码'`),u(`))
                        } `),i(`span`,{class:`hljs-keyword`},`else`),u(` {
                          `),i(`span`,{class:`hljs-comment`},`// 假如当前表单名为form1。获取组件password的值和当前值对比`),u(`
                          `),i(`span`,{class:`hljs-keyword`},`const`),u(` password = `),i(`span`,{class:`hljs-title function_`},`getform1ValueByName`),u(`(`),i(`span`,{class:`hljs-string`},`'password'`),u(`)
                          `),i(`span`,{class:`hljs-keyword`},`if`),u(` (password === value) {
                            `),i(`span`,{class:`hljs-title function_`},`callback`),u(`()
                          }
                          `),i(`span`,{class:`hljs-title function_`},`callback`),u(`(`),i(`span`,{class:`hljs-keyword`},`new`),u(),i(`span`,{class:`hljs-title class_`},`Error`),u(`(`),i(`span`,{class:`hljs-string`},`'两次密码输入不一致'`),u(`))
                        }
                      },
                      `),i(`span`,{class:`hljs-attr`},`trigger`),u(`: `),i(`span`,{class:`hljs-string`},`"blur"`),u(`
                    }]
