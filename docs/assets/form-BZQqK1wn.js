      ...
      <span class="hljs-attr">config</span>:
        {
          ...
          <span class="hljs-attr">before</span>: <span class="hljs-function">(<span class="hljs-params">params, obj</span>) =&gt;</span>
          {
  ...
  <span class="hljs-attr">apiKey</span>:
    {
      ...
      <span class="hljs-attr">get</span>: <span class="hljs-string">&quot;get&quot;</span>
    },
...
}</code></pre>`,18),p=[l],h={__name:"form",setup(r){return(e,o)=>(s(),a("div",n,p))}};export{h as default};
