...
yarn dev
</code></pre><p data-source-line="53">浏览器进入 <a href="http://localhost:3000">http://localhost:3000</a> 开始体验</p><h2 id="代码模式" data-source-line="55"><a class="markdownIt-Anchor" href="#代码模式">#</a> 代码模式</h2><p data-source-line="57">代码编辑输入框可支持<code>json</code>或<code>javascript</code>两种模式，初始使用时可通过修改<code>/src/utils/form.ts</code>里的<code>EDITTYPE</code>的值</p>`,18),v=[m];function _(a,s,e,c,n,o){return p(),h("div",f,v)}const k=d(j,[["render",_]]);export{k as default};
