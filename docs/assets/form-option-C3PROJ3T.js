import{d as k,p as d,c as C,o as h,f as s,v as g,ae as E,x as B,t as b,L as y,r as j,b as f,af as m,j as c,w as p,l as a,m as A}from"./index-B7joXn-H.js";/* empty css                                                            */const D={class:"doc-preview"},v={class:"component"},w={class:"fixed-tools"},F={class:"code"},_={class:"control-tools"},x=k({__name:"vue",props:{code:{}},setup(i){const t=i,n=d(!1),e=()=>{try{navigator.clipboard.writeText(decodeURIComponent(t.code))}catch(r){console.log(r)}},l=()=>{n.value=!n.value};return(r,o)=>(h(),C("div",D,[s("div",v,[E(r.$slots,"default",{},void 0,!0)]),g(s("div",w,[s("div",{class:"tools"},[s("div",{class:"item",onClick:e},[...o[0]||(o[0]=[s("svg",{fill:"none",height:"20",stroke:"currentColor","stroke-width":"2",viewBox:"0 0 24 24",width:"20",xmlns:"http://www.w3.org/2000/svg"},[s("path",{d:"M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2m-6 9 2 2 4-4","stroke-linecap":"round","stroke-linejoin":"round"})],-1)])]),s("div",{class:"item",onClick:l},[...o[1]||(o[1]=[s("svg",{height:"20",viewBox:"0 0 512 512",width:"20",xmlns:"http://www.w3.org/2000/svg"},[s("path",{d:"M160 368L32 256l128-112M352 368l128-112-128-112M304 96l-96 320",fill:"none",stroke:"currentColor","stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"46"})],-1)])])])],512),[[B,n.value]]),g(s("div",F,[E(r.$slots,"code",{},void 0,!0)],512),[[B,n.value]]),s("div",_,[s("div",{class:"text",onClick:l},b(n.value?"隐藏代码":"展开代码"),1),s("div",{class:"tools"},[s("div",{class:"item",onClick:e},[...o[2]||(o[2]=[s("svg",{fill:"none",height:"20",stroke:"currentColor","stroke-width":"2",viewBox:"0 0 24 24",width:"20",xmlns:"http://www.w3.org/2000/svg"},[s("path",{d:"M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2m-6 9 2 2 4-4","stroke-linecap":"round","stroke-linejoin":"round"})],-1)])]),s("div",{class:"item",onClick:l},[...o[3]||(o[3]=[s("svg",{height:"20",viewBox:"0 0 512 512",width:"20",xmlns:"http://www.w3.org/2000/svg"},[s("path",{d:"M160 368L32 256l128-112M352 368l128-112-128-112M304 96l-96 320",fill:"none",stroke:"currentColor","stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"46"})],-1)])])])])]))}}),u=y(x,[["__scopeId","data-v-f4df5ce4"]]),V={__name:"form-option.md.Virtualb90a1da5",setup(i){const t=d({list:[{type:"inputSlot",control:{modelValue:"",teleported:!0,style:{width:"100px"}},options:[{label:"选项1",value:"1"}],config:{optionsType:0,optionsFun:""},name:"select1",formItem:{label:"下拉选择框"}},{type:"input",control:{modelValue:""},config:{prepend:"",append:"key:select1"},name:"input1724465076902",formItem:{label:"单行文本"}}],form:{size:"default"},config:{submitCancel:!1}});return(n,e)=>{const l=j("ak-form");return h(),f(l,{data:t.value},null,8,["data"])}}},N={__name:"form-option.md.Virtual57374397",setup(i){const t=d({list:[{type:"input",control:{modelValue:"",placeholder:"值发生改变时，下拉选择框会重新发起请求"},config:{},name:"name1",formItem:{label:"单行文本"}},{type:"select",control:{modelValue:"",teleported:!0,remote:!1,filterable:!1},options:[],config:{optionsType:1,optionsFun:"demo/options",method:"get",linkage:"name1",before:(n,{type:e,route:l,model:r})=>(console.log(e),n),after:(n,e,l)=>(console.log(l,n),n)},name:"select1",formItem:{label:"下拉选择框"}}],form:{size:"default"},config:{submitCancel:!1}});return(n,e)=>{const l=j("ak-form");return h(),f(l,{data:t.value},null,8,["data"])}}},I={__name:"form-option.md.Virtuale3af3e96",setup(i){const t=d({list:[{type:"input",control:{modelValue:""},config:{},name:"password",formItem:{label:"密码"},customRules:[{type:"required",message:"必填项",trigger:"blur"}]},{type:"input",control:{modelValue:""},config:{},name:"password2",formItem:{label:"确认密码",rules:[{validator:(n,e,l)=>{e===""?l(new Error("请输入确认密码")):(getform1ValueByName("password")===e&&l(),l(new Error("两次密码输入不一致")))},trigger:"blur"}]},customRules:[{type:"required",message:"必填项",trigger:"blur"}]}],form:{size:"default",name:"form1"},config:{submitCancel:!0}});return(n,e)=>{const l=j("ak-form");return h(),f(l,{data:t.value},null,8,["data"])}}},S={class:"marked-body"},R={__name:"form-option",setup(i){return(t,n)=>(h(),C("div",S,[n[3]||(n[3]=m(`<h1 id="ak-form 配置手册"><a name="ak-form-" class="anchor" href="#ak-form-"><span class="header-link"></span></a> ak-form 配置手册 </h1><p>配置数据由表单设计器通过拖拽添加相应组件及填写对应字段配置自动生成。脱离表单设计器时可按此数据格式要求，直接使用<code>ak-form</code>表单，即<code>ak-form</code>表单组件可不依懒于表单设计器工作。</p><h2 id="表单配置"><a name="-" class="anchor" href="#-"><span class="header-link"></span></a> 表单配置 </h2><h3 id="- 表单名称"><a name="-" class="anchor" href="#-"><span class="header-link"></span></a> - 表单名称 </h3><p><code>config.name</code></p><p>用于保存的表单设计显示的名称</p><h3 id="- 数据源"><a name="-" class="anchor" href="#-"><span class="header-link"></span></a> - 数据源 </h3><p><code>config.soucrceId</code></p><p>指定当前表单数据的对应的数据库表，即当前表单数据保存对应的数据库id。若没有配置数据源，则需在下面的接口数据事件中配置增删查改相关的url</p><h3 id="- 表单标识"><a name="-" class="anchor" href="#-"><span class="header-link"></span></a> - 表单标识 </h3><p><code>form.name</code></p><p>当前表单的名称，可根据此标识使用<code>get[formName]ControlByName</code>获得当前其他选项数据</p><h3 id="- 表单标签宽度"><a name="-" class="anchor" href="#-"><span class="header-link"></span></a> - 表单标签宽度 </h3><p><code>form.labelWidth</code></p><p><code>el-form</code>的表单属性，设置表单label的宽度</p><h3 id="- 表单样式名称"><a name="-" class="anchor" href="#-"><span class="header-link"></span></a> - 表单样式名称 </h3><p><code>form.class</code></p><p>自定义的表单样式名称，可快速选择内置好的表单布局类名，或自定义类名</p><h3 id="- 字段名后添加冒号"><a name="-" class="anchor" href="#-"><span class="header-link"></span></a> - 字段名后添加冒号 </h3><p><code>form.showColon</code></p><p>统一设置表单label是否添加冒号</p><h3 id="- 组件尺寸"><a name="-" class="anchor" href="#-"><span class="header-link"></span></a> - 组件尺寸 </h3><p><code>form.size</code></p><p><code>el-form</code>的表单属性</p><h3 id="- 快速添加确定取消按钮"><a name="-" class="anchor" href="#-"><span class="header-link"></span></a> - 快速添加确定取消按钮 </h3><p><code>config.submitCancel</code></p><ul><li>类型：boolean/string[]</li></ul><p>快速添加表单提交和取消按钮。设置为<code>true</code>可快速显示<code>确定</code>和<code>取消</code>两个按钮，如其他可自定义，格式为</p><pre class="language-javascript"><code class="hljs"><span class="hljs-keyword">const</span> submitCancel = [
  {
...
`)]),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"script"),a(">")])])],-1)])]),default:p(()=>[c(I)]),_:1}),n[7]||(n[7]=m('<ul><li><p>除系统内置的校验规则，还可通过可<code>@/components/form/validate.ts</code>扩展，添加常用校验规则</p></li><li><p>对于选择类的如select、checkbox类的可以校验是否为空</p></li></ul><h3 id="其他属性"><a name="-" class="anchor" href="#-"><span class="header-link"></span></a> 其他属性 </h3><p>可通过其他属性弹窗编写当前组件的prop，详见ui官网</p><h2 id="表单方法"><a name="-" class="anchor" href="#-"><span class="header-link"></span></a> 表单方法 </h2><h3 id="- get[formName]ControlByName"><a name="-get-formname-controlbyname" class="anchor" href="#-get-formname-controlbyname"><span class="header-link"></span></a> - get[formName]ControlByName </h3><ul><li>类型：function(name)</li></ul><p>表单页全局方法，用于根据组件<code>form.name</code>值获取当前的数据项。</p><p>注意：<code>formName</code>值为表单唯一标识，即<code>form.name</code></p><pre class="language-javascript"><code class="hljs"><span class="hljs-keyword">const</span> control = <span class="hljs-title function_">getformNameControlByName</span>(<span class="hljs-string">&#39;name&#39;</span>)</code></pre><h3 id="- get[formName]ValueByName"><a name="-get-formname-valuebyname" class="anchor" href="#-get-formname-valuebyname"><span class="header-link"></span></a> - get[formName]ValueByName </h3><ul><li>类型：function(name)</li></ul><p>同get[formName]ControlByName。返回值不一样</p>',12))]))}};export{R as default};
