...
};</code></pre><h3>深度使用表格(完整配置设置)</h3><pre class="language-javascript"><code class="hljs"><span class="hljs-keyword">const</span> opt = {
