import{d as D,l as d,c as C,o as h,f as s,s as f,ae as E,v as B,t as b,L as y,r as j,b as g,af as A,j as c,w as r,m as a,I as m}from"./index-CYQNA_yI.js";/* empty css                                                            */const v={class:"doc-preview"},k={class:"component"},w={class:"fixed-tools"},F={class:"code"},_={class:"control-tools"},x=D({__name:"vue",props:{code:{}},setup(i){const t=i,l=d(!1),e=()=>{try{navigator.clipboard.writeText(decodeURIComponent(t.code))}catch(p){console.log(p)}},n=()=>{l.value=!l.value};return(p,o)=>(h(),C("div",v,[s("div",k,[E(p.$slots,"default",{},void 0,!0)]),f(s("div",w,[s("div",{class:"tools"},[s("div",{class:"item",onClick:e},[...o[0]||(o[0]=[s("svg",{fill:"none",height:"20",stroke:"currentColor","stroke-width":"2",viewBox:"0 0 24 24",width:"20",xmlns:"http://www.w3.org/2000/svg"},[s("path",{d:"M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2m-6 9 2 2 4-4","stroke-linecap":"round","stroke-linejoin":"round"})],-1)])]),s("div",{class:"item",onClick:n},[...o[1]||(o[1]=[s("svg",{height:"20",viewBox:"0 0 512 512",width:"20",xmlns:"http://www.w3.org/2000/svg"},[s("path",{d:"M160 368L32 256l128-112M352 368l128-112-128-112M304 96l-96 320",fill:"none",stroke:"currentColor","stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"46"})],-1)])])])],512),[[B,l.value]]),f(s("div",F,[E(p.$slots,"code",{},void 0,!0)],512),[[B,l.value]]),s("div",_,[s("div",{class:"text",onClick:n},b(l.value?"隐藏代码":"展开代码"),1),s("div",{class:"tools"},[s("div",{class:"item",onClick:e},[...o[2]||(o[2]=[s("svg",{fill:"none",height:"20",stroke:"currentColor","stroke-width":"2",viewBox:"0 0 24 24",width:"20",xmlns:"http://www.w3.org/2000/svg"},[s("path",{d:"M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2m-6 9 2 2 4-4","stroke-linecap":"round","stroke-linejoin":"round"})],-1)])]),s("div",{class:"item",onClick:n},[...o[3]||(o[3]=[s("svg",{height:"20",viewBox:"0 0 512 512",width:"20",xmlns:"http://www.w3.org/2000/svg"},[s("path",{d:"M160 368L32 256l128-112M352 368l128-112-128-112M304 96l-96 320",fill:"none",stroke:"currentColor","stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"46"})],-1)])])])])]))}}),u=y(x,[["__scopeId","data-v-22fbd600"]]),V={__name:"form-option.md.Virtualb90a1da5",setup(i){const t=d({list:[{type:"inputSlot",control:{modelValue:"",teleported:!0,style:{width:"100px"}},options:[{label:"选项1",value:"1"}],config:{optionsType:0,optionsFun:""},name:"select1",formItem:{label:"下拉选择框"}},{type:"input",control:{modelValue:""},config:{prepend:"",append:"key:select1"},name:"input1724465076902",formItem:{label:"单行文本"}}],form:{size:"default"},config:{submitCancel:!1}});return(l,e)=>{const n=j("ak-form");return h(),g(n,{data:t.value},null,8,["data"])}}},N={__name:"form-option.md.Virtual57374397",setup(i){const t=d({list:[{type:"input",control:{modelValue:"",placeholder:"值发生改变时，下拉选择框会重新发起请求"},config:{},name:"name1",formItem:{label:"单行文本"}},{type:"select",control:{modelValue:"",teleported:!0,remote:!1,filterable:!1},options:[],config:{optionsType:1,optionsFun:"demo/options",method:"get",linkage:"name1",before:(l,{type:e,route:n,model:p})=>(console.log(e),l),after:(l,e,n)=>(console.log(n,l),l)},name:"select1",formItem:{label:"下拉选择框"}}],form:{size:"default"},config:{submitCancel:!1}});return(l,e)=>{const n=j("ak-form");return h(),g(n,{data:t.value},null,8,["data"])}}},I={__name:"form-option.md.Virtuale3af3e96",setup(i){const t=d({list:[{type:"input",control:{modelValue:""},config:{},name:"password",formItem:{label:"密码"},customRules:[{type:"required",message:"必填项",trigger:"blur"}]},{type:"input",control:{modelValue:""},config:{},name:"password2",formItem:{label:"确认密码",rules:[{validator:(l,e,n)=>{e===""?n(new Error("请输入确认密码")):(getform1ValueByName("password")===e&&n(),n(new Error("两次密码输入不一致")))},trigger:"blur"}]},customRules:[{type:"required",message:"必填项",trigger:"blur"}]}],form:{size:"default",name:"form1"},config:{submitCancel:!0}});return(l,e)=>{const n=j("ak-form");return h(),g(n,{data:t.value},null,8,["data"])}}},S={class:"marked-body"},z={__name:"form-option",setup(i){return(t,l)=>(h(),C("div",S,[l[3]||(l[3]=A(`<h1>ak-form 配置手册</h1><p>配置数据由表单设计器通过拖拽添加相应组件及填写对应字段配置自动生成。脱离表单设计器时可按此数据格式要求，直接使用<code>ak-form</code>表单，即<code>ak-form</code>表单组件可不依懒于表单设计器工作。</p><h2>表单配置</h2><h3>- 表单名称</h3><p><code>config.name</code></p><p>用于保存的表单设计显示的名称</p><h3>- 数据源</h3><p><code>config.soucrceId</code></p><p>指定当前表单数据的对应的数据库表，即当前表单数据保存对应的数据库id。若没有配置数据源，则需在下面的接口数据事件中配置增删查改相关的url</p><h3>- 表单标识</h3><p><code>form.name</code></p><p>当前表单的名称，可根据此标识使用<code>get[formName]ControlByName</code>获得当前其他选项数据</p><h3>- 表单标签宽度</h3><p><code>form.labelWidth</code></p><p><code>el-form</code>的表单属性，设置表单label的宽度</p><h3>- 表单样式名称</h3><p><code>form.class</code></p><p>自定义的表单样式名称，可快速选择内置好的表单布局类名，或自定义类名</p><h3>- 字段名后添加冒号</h3><p><code>form.showColon</code></p><p>统一设置表单label是否添加冒号</p><h3>- 组件尺寸</h3><p><code>form.size</code></p><p><code>el-form</code>的表单属性</p><h3>- 快速添加确定取消按钮</h3><p><code>config.submitCancel</code></p><ul><li>类型：boolean/string[]</li></ul><p>快速添加表单提交和取消按钮。设置为<code>true</code>可快速显示<code>确定</code>和<code>取消</code>两个按钮，如其他可自定义，格式为</p><pre class="language-javascript"><code class="hljs"><span class="hljs-keyword">const</span> submitCancel = [
  {
...
]</code></pre><h3>- 将object转string提交</h3><p><code>config.transformData</code></p><ul><li>类型：boolean</li></ul><p>统一数据提交格式，开启后会尝试将<code>object</code>类型的数据使用<code>JSON.stringify</code>转换后提交保存。根据id查询详情时再尝试使用<code>JSON.parse</code>恢复。</p><h3>- 编辑表单样式</h3><p><code>config.style</code></p><p>编写有样式时会在当前页面head中插入style脚本，作用范围为当前页面。相当于.vue文件中的style scoped中的样式。</p><h3>- 新增修改数据保存url</h3><p><code>config.submit</code></p><p>点击表单提交按钮后数据保存的url接口地址，如当前表单设定了数据源，提交时则保存到对应的数据库表中，此时可不设置</p><p>同add</p><h3>- 获取表单数据url</h3><p><code>config.requestUrl</code></p><p>编辑时获取表单初始值接口url，用法同add</p><h3>- before事件</h3><p><code>events.before</code></p><ul><li>类型：before?: string | ((params: any, obj: any) =&gt; any)</li></ul><p>请求列表数据，编辑和删除等接口事件发送请求前执行事件，这里可对发送的数据进行拦截处理。</p><ul><li>params请求的参数，可对此参数进行修改，然后return回去</li><li>obj.type支持的类型，表单数据<code>get | add | edit</code>，选项数据<code>linkage | remote | edit | default</code>用于表示接口事件类型</li><li>obj.route当前页面路由信息</li><li>obj.model当前表单值</li></ul><p>同时支持string字符串类型，这个需要自定义开发，适用于处理一些比较复杂的逻辑处理时，根据设置的字符将处理逻辑写入本地文件。可查看<code>/src/utils/beforeAfter.ts</code>根据提示完成</p><h3>- after事件</h3><p><code>events.after</code></p><ul><li>类型：after?: string | ((res: any, success: boolean, type?: string) =&gt; any)</li></ul><p>类似于前面的<code>before</code>。最后需要将处理后的结果 return res</p><h3>- change事件</h3><p><code>events.change</code></p><ul><li>类型：change?: string | ({ name, value, prop, options }) =&gt; any)</li></ul><p>表单组件改变事件，可修改model后返回。即可实现当组件a改变时，修改b组件的值</p><ul><li>key 当前组件的name值</li><li>model 当前表单的值</li></ul><pre class="language-javascript"><code class="hljs"><span class="hljs-keyword">const</span> opt={
...
`)]),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"script"),a(">")])])],-1)])]),default:r(()=>[c(V)]),_:1}),l[4]||(l[4]=A(`<p>其他通用属性大部分都是当前组件的一些属性，比较容易理解，这里就不一一介绍了。</p><h3>选项配置</h3><p> 支持组件<code>radio、select、checkbox、cascader、treeSelect</code>配置选项数据</p><h4>- 选项数据源</h4><p><code>config.optionsType</code></p><ul><li>类型：number 可选值0固定数据；1接口数据；2字典数据</li></ul><h4>- 选项数据源接口URL</h4><p><code>config.optionsFun</code></p><ul><li>类型：string</li></ul><ul><li>当config.optionsType===1时，为接口url</li><li>当config.optionsType===2时，为字典标识</li></ul><h4>- 远程数据参数字段名</h4><p><code>config.queryName</code></p><ul><li>类型：string default:&#39;name&#39;</li></ul><p>当开启了<code>Remote</code>远程数据时有效，作为参数请求接口，如<code>{name:&#39;xxx&#39;}</code></p><h4>- 开启远程数据Remote</h4><p><code>config.remote</code></p><ul><li>类型：boolean</li></ul><p>用于从接口数据中提取指定的字段作为下拉选项的label值，默认为<code>label</code>。如接口返回没有<code>label</code>和<code>value</code>字段，则需设置。当值发生变化时，将根据输入的参数从配置的<code>config. optionsFun</code>接口地址获取选项数据，参数key可通过<code>config.queryName</code>设置。</p><p><strong>远程数据编辑回显问题</strong></p><p>当<code>label</code>和<code>value</code>不相同时，接口服务端保存的一般为<code>value</code>值，由于是远程搜索在编辑时只能显示<code>value</code>的值。 为方便回显目前暂定在搜索时根据<code>value</code>的值请求，接口需要能够根据value id查找出初始默认值</p><h4>- 指定label属性值</h4><p><code>config.label</code></p><ul><li>当config.optionsType===1时有效</li></ul><p>用于从接口数据中提取指定的字段作为下拉选项的label值，默认为<code>label</code>。如接口返回没有<code>label</code>和<code>value</code>字段，则需设置</p><pre class="language-javascript"><code class="hljs"><span class="hljs-comment">// 接口返回数据为name和id,则此时需要设置label=&#39;name&#39;,valule=&#39;id&#39;</span>
...
]</code></pre><h4>- 指定value属性值</h4><p><code>config.value</code></p><p>同上面label</p><h4>- 缓存数据结果</h4><p><code>config.cache</code></p><ul><li><p>类型：boolean</p></li><li><p>当config.optionsType===1时有效</p></li></ul><p>将接口返回的数据存在sessionStorage，减少重复请求</p><h4>- 尝试转换value值为</h4><p><code>config.transformData</code></p><ul><li>可选值 none、number、string</li></ul><p>对组件的数字值进行转换，Number型数字和String型数字互转。实际场景：</p><pre class="language-javascript"><code class="hljs"><span class="hljs-comment">// 接口返回的value为String类型时</span>
...
`)]),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"script"),a(">")])])],-1)])]),default:r(()=>[c(I)]),_:1}),l[7]||(l[7]=A('<ul><li><p>除系统内置的校验规则，还可通过可<code>@/components/form/validate.ts</code>扩展，添加常用校验规则</p></li><li><p>对于选择类的如select、checkbox类的可以校验是否为空</p></li></ul><h3>其他属性</h3><p>可通过其他属性弹窗编写当前组件的prop，详见ui官网</p><h2>表单方法</h2><h3>- get[formName]ControlByName</h3><ul><li>类型：function(name)</li></ul><p>表单页全局方法，用于根据组件<code>form.name</code>值获取当前的数据项。</p><p>注意：<code>formName</code>值为表单唯一标识，即<code>form.name</code></p><pre class="language-javascript"><code class="hljs"><span class="hljs-keyword">const</span> control = <span class="hljs-title function_">getformNameControlByName</span>(<span class="hljs-string">&#39;name&#39;</span>)</code></pre><h3>- get[formName]ValueByName</h3><ul><li>类型：function(name)</li></ul><p>同get[formName]ControlByName。返回值不一样</p>',12))]))}};export{z as default};
