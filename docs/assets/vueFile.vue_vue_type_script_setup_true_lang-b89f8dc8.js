...
<script setup lang="ts">
  ...
  ${d}
<\/script>
${l}`;$(()=>{k.value=F(v,"editJsonCopy","html")})},o=t=>{$(()=>{const l=new ge(t.target,{text:()=>k.value.getValue()});l.on("success",function(){G({message:"复制成功！",type:"success"}),l.destroy()}),l.on("error",function(){G.error("复制失败"),l.destroy()}),l.onClick(t)})},p=()=>{var i;const t="data:text/csv;charset=utf-8,"+((i=k.value)==null?void 0:i.getValue()),l=new Date().getTime()+".vue",d=encodeURI(t),m=document.createElement("a");m.setAttribute("href",d),m.setAttribute("download",l),m.click()};return D({open:u,openTable:f,openScreen:e}),(t,l)=>{const d=I("el-button"),m=I("el-dialog");return N(),W(m,{modelValue:b.value,"onUpdate:modelValue":l[0]||(l[0]=i=>b.value=i),title:"导出vue文件",class:"export-dialog",width:"80%"},{footer:T(()=>[V("div",be,[J(d,{size:"small",type:"primary",onClick:o},{default:T(()=>[B(" 复制数据 ")]),_:1}),J(d,{type:"primary",size:"small",onClick:p},{default:T(()=>[B(" 导出代码 ")]),_:1})])]),default:T(()=>[he]),_:1},8,["modelValue"])}}});export{Ee as _,Se as a};
