...
</code></pre><h3 id="全局方法" data-source-line="376"><a class="markdownIt-Anchor" href="#全局方法">#</a> 全局方法</h3><p data-source-line="378"><strong>get[formName]ControlByName</strong></p><p data-source-line="380">formName　为设计表单时表单配置-表单标识。注意：使用此方法必须设置表单标识</p><p data-source-line="382">根据name值获取formData中的数据项(name:string)</p><p data-source-line="384"><strong>get[formName]ValueByName</strong></p><p data-source-line="386">根据name值获取当前表单对应的值</p><p data-source-line="388">实例可参考<a href="/#/system/user">系统工具-用户管理密码校验</a></p>`,94);function $(u,l,a,i,e,n){const h=t("mrow"),m=t("annotation"),g=t("semantics"),j=t("math");return _(),q("div",N,[A,s("p",U,[p("编写联动条件表达式，可使用&&和||等运算符，当满足条件时可将该组件设置为显示/隐藏或者是启用/禁用。其中"),s("span",C,[s("span",L,[o(j,null,{default:r(()=>[o(g,null,{default:r(()=>[o(h),o(m,{encoding:"application/x-tex"})]),_:1})]),_:1})]),B]),p(" 表示当前表单的值。例如表单中有name=sex的单选值及name=age的文本输入，即当sex选中了1和age输入框的值大于20时条件成立")]),V])}const T=f(I,[["render",$]]);export{T as default};
