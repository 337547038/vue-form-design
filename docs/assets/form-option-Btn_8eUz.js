import{d as y,l as h,o as i,c as C,g as s,af as f,s as E,v as B,t as D,ah as b,ai as _,N as v,r as u,b as j,i as p,w as r,C as A,ag as g,m as a}from"./index-CDYjrzCG.js";/* empty css                                                            */const d=t=>(b("data-v-43edb7f1"),t=t(),_(),t),k={class:"doc-preview"},w={class:"component"},F={class:"fixed-tools"},x=d(()=>s("svg",{fill:"none",height:"20",stroke:"currentColor","stroke-width":"2",viewBox:"0 0 24 24",width:"20",xmlns:"http://www.w3.org/2000/svg"},[s("path",{d:"M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2m-6 9 2 2 4-4","stroke-linecap":"round","stroke-linejoin":"round"})],-1)),V=[x],I=d(()=>s("svg",{height:"20",viewBox:"0 0 512 512",width:"20",xmlns:"http://www.w3.org/2000/svg"},[s("path",{d:"M160 368L32 256l128-112M352 368l128-112-128-112M304 96l-96 320",fill:"none",stroke:"currentColor","stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"46"})],-1)),N=[I],S={class:"code"},T={class:"control-tools"},K=d(()=>s("svg",{fill:"none",height:"20",stroke:"currentColor","stroke-width":"2",viewBox:"0 0 24 24",width:"20",xmlns:"http://www.w3.org/2000/svg"},[s("path",{d:"M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2m-6 9 2 2 4-4","stroke-linecap":"round","stroke-linejoin":"round"})],-1)),M=[K],z=d(()=>s("svg",{height:"20",viewBox:"0 0 512 512",width:"20",xmlns:"http://www.w3.org/2000/svg"},[s("path",{d:"M160 368L32 256l128-112M352 368l128-112-128-112M304 96l-96 320",fill:"none",stroke:"currentColor","stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"46"})],-1)),R=[z],q=y({__name:"vue",props:{code:{}},setup(t){const o=t,n=h(!1),e=()=>{try{navigator.clipboard.writeText(decodeURIComponent(o.code))}catch(c){console.log(c)}},l=()=>{n.value=!n.value};return(c,Z)=>(i(),C("div",k,[s("div",w,[f(c.$slots,"default",{},void 0,!0)]),E(s("div",F,[s("div",{class:"tools"},[s("div",{class:"item",onClick:e},V),s("div",{class:"item",onClick:l},N)])],512),[[B,n.value]]),E(s("div",S,[f(c.$slots,"code",{},void 0,!0)],512),[[B,n.value]]),s("div",T,[s("div",{class:"text",onClick:l},D(n.value?"隐藏代码":"展开代码"),1),s("div",{class:"tools"},[s("div",{class:"item",onClick:e},M),s("div",{class:"item",onClick:l},R)])])]))}}),m=v(q,[["__scopeId","data-v-43edb7f1"]]),$={__name:"form-option.md.Virtualeacf844f",setup(t){const o=h({list:[{type:"inputSlot",control:{modelValue:"",teleported:!0,style:{width:"100px"}},options:[{label:"选项1",value:"1"}],config:{optionsType:0,optionsFun:""},name:"select1",formItem:{label:"下拉选择框"}},{type:"input",control:{modelValue:""},config:{prepend:"",append:"key:select1"},name:"input1724465076902",formItem:{label:"单行文本"}}],form:{size:"default"},config:{submitCancel:!1},apiKey:{}});return(n,e)=>{const l=u("ak-form");return i(),j(l,{data:o.value},null,8,["data"])}}},P={__name:"form-option.md.Virtual5b92fc16",setup(t){const o=h({list:[{type:"input",control:{modelValue:"",placeholder:"值发生改变时，下拉选择框会重新发起请求"},config:{},name:"name1",formItem:{label:"单行文本"}},{type:"select",control:{modelValue:"",teleported:!0,remote:!1,filterable:!1},options:[],config:{optionsType:1,optionsFun:"demo/options",method:"get",linkage:"name1",before:(n,{type:e,route:l,model:c})=>(console.log(e),n),after:(n,e,l)=>(console.log(l,n),n)},name:"select1",formItem:{label:"下拉选择框"}}],form:{size:"default"},config:{submitCancel:!1},apiKey:{}});return(n,e)=>{const l=u("ak-form");return i(),j(l,{data:o.value},null,8,["data"])}}},L={__name:"form-option.md.Virtual47fa4e6f",setup(t){const o=h({list:[{type:"input",control:{modelValue:""},config:{},name:"password",formItem:{label:"密码"},customRules:[{type:"required",message:"必填项",trigger:"blur"}]},{type:"input",control:{modelValue:""},config:{},name:"password2",formItem:{label:"确认密码",rules:[{validator:(n,e,l)=>{e===""?l(new Error("请输入确认密码")):(getform1ValueByName("password")===e&&l(),l(new Error("两次密码输入不一致")))},trigger:"blur"}]},customRules:[{type:"required",message:"必填项",trigger:"blur"}]}],form:{size:"default",name:"form1"},config:{submitCancel:!0},apiKey:{}});return(n,e)=>{const l=u("ak-form");return i(),j(l,{data:o.value},null,8,["data"])}}},H={class:"marked-body"},J=g(`<h1 id="ak-form-配置手册">ak-form 配置手册</h1><p>配置数据由表单设计器通过拖拽添加相应组件及填写对应字段配置自动生成。脱离表单设计器时可按此数据格式要求，直接使用<code>ak-form</code>表单，即<code>ak-form</code>表单组件可不依懒于表单设计器工作。</p><h2 id="表单配置">表单配置</h2><h3 id="--表单名称">- 表单名称</h3><p><code>config.name</code></p><p>用于保存的表单设计显示的名称</p><h3 id="--数据源">- 数据源</h3><p><code>config.soucrceId</code></p><p>指定当前表单数据的对应的数据库表，即当前表单数据保存对应的数据库id。若没有配置数据源，则需在下面的接口数据事件中配置增删查改相关的url</p><h3 id="--表单标识">- 表单标识</h3><p><code>form.name</code></p><p>当前表单的名称，可根据此标识使用<code>get[formName]ControlByName</code>获得当前其他选项数据</p><h3 id="--表单标签宽度">- 表单标签宽度</h3><p><code>form.labelWidth</code></p><p><code>el-form</code>的表单属性，设置表单label的宽度</p><h3 id="--表单样式名称">- 表单样式名称</h3><p><code>form.class</code></p><p>自定义的表单样式名称，可快速选择内置好的表单布局类名，或自定义类名</p><h3 id="--字段名后添加冒号">- 字段名后添加冒号</h3><p><code>form.showColon</code></p><p>统一设置表单label是否添加冒号</p><h3 id="--组件尺寸">- 组件尺寸</h3><p><code>form.size</code></p><p><code>el-form</code>的表单属性</p><h3 id="--快速添加确定取消按钮">- 快速添加确定取消按钮</h3><p><code>config.submitCancel</code></p><ul><li>类型：boolean/string[]</li></ul><p>快速添加表单提交和取消按钮。为数组时可指定显示的名称，如[&#39;保存&#39;,&#39;取消&#39;]</p><h3 id="--将object转string提交">- 将object转string提交</h3><p><code>config.transformData</code></p><ul><li>类型：boolean</li></ul><p>统一数据提交格式，开启后会尝试将<code>object</code>类型的数据使用<code>JSON.stringify</code>转换后提交保存。根据id查询详情时再尝试使用<code>JSON.parse</code>恢复。</p><h3 id="--编辑表单样式">- 编辑表单样式</h3><p><code>config.style</code></p><p>编写有样式时会在当前页面head中插入style脚本，作用范围为当前页面。相当于.vue文件中的style scoped中的样式。</p><h3 id="--新增数据保存url">- 新增数据保存url</h3><p><code>apiKey.add</code></p><p>点击表单提交按钮后数据保存的url接口地址，如当前表单设定了数据源，提交时则保存到对应的数据库表中，此时可不设置</p><h3 id="--修改数据保存url">- 修改数据保存url</h3><p><code>apiKey.edit</code></p><p>同add</p><h3 id="--获取表单数据url">- 获取表单数据url</h3><p><code>apiKey.get</code></p><p>编辑时获取表单初始值接口url，用法同add</p><h3 id="--before事件">- before事件</h3><p><code>events.before</code></p><ul><li>类型：before?: string | ((params: any, obj: any) =&gt; any)</li></ul><p>请求列表数据，编辑和删除等接口事件发送请求前执行事件，这里可对发送的数据进行拦截处理。</p><ul><li>params请求的参数，可对此参数进行修改，然后return回去</li><li>obj.type支持的类型，表单数据<code>get | add | edit</code>，选项数据<code>linkage | remote | edit | default</code>用于表示接口事件类型</li><li>obj.route当前页面路由信息</li><li>obj.model当前表单值</li></ul><p>同时支持string字符串类型，这个需要自定义开发，适用于处理一些比较复杂的逻辑处理时，根据设置的字符将处理逻辑写入本地文件。可查看<code>/src/utils/beforeAfter.ts</code>根据提示完成</p><h3 id="--after事件">- after事件</h3><p><code>events.after</code></p><ul><li>类型：after?: string | ((res: any, success: boolean, type?: string) =&gt; any)</li></ul><p>类似于前面的<code>before</code>。最后需要将处理后的结果 return res</p><h3 id="--change事件">- change事件</h3><p><code>events.change</code></p><ul><li>类型：change?: string | ((key: string, model: any) =&gt; any)</li></ul><p>表单组件改变事件，可修改model后返回。即可实现当组件a改变时，修改b组件的值</p><ul><li>key 当前组件的name值</li><li>model 当前表单的值</li></ul><pre class="language-javascript"><code class="hljs"><span class="hljs-keyword">const</span> opt={
...
<span class="hljs-comment">// 此时无法回显正常的值，&lt;el-select v-model=result.value/&gt;</span></code></pre><h4 id="--联动关联">- 联动关联</h4><p><code>config.linkage</code></p><ul><li>类型：string</li></ul><p>实现如省市联动的效果，当关联的name发生改变时，当前组件会重新根据name对应组件值发起请求。可查看示例控制面板输出</p>`,41),W=s("pre",{class:"language-xml"},[s("code",{class:"hljs"},[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
...
`)]),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"script"),a(">")])])],-1),G=s("h3",{id:"校验设置"},"校验设置",-1),Q=s("ul",null,[s("li",null,[a("对于input输入框，我们提供了丰富的校验规则，你只需选择校验的正确类型和输入提示语即可。如还不满足使用，可通过"),s("code",null,"编写校验规则"),a("弹窗编写规则，如")])],-1),X=s("pre",{class:"language-xml"},[s("code",{class:"hljs"},[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
  `),s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"ak-form"),a(),s("span",{class:"hljs-attr"},":data"),a("="),s("span",{class:"hljs-string"},'"formData"'),a(">")]),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"ak-form"),a(">")]),a(`
`),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
`),s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"script"),a(),s("span",{class:"hljs-attr"},"setup"),a(">")]),s("span",{class:"language-javascript"},[a(`
  `),s("span",{class:"hljs-keyword"},"import"),a(" {ref} "),s("span",{class:"hljs-keyword"},"from"),a(),s("span",{class:"hljs-string"},"'vue'"),a(`
