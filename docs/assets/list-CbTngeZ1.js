...
<span class="hljs-keyword">const</span> newBtn={
  ...
  <span class="hljs-attr">treeData</span>:<span class="hljs-comment">//侧栏树相关配置</span>
  {
    ...
    <span class="hljs-attr">before</span>: <span class="hljs-function">(<span class="hljs-params">params, { type, route, model }</span>) =&gt;</span>
    {
  ...
  { <span class="hljs-comment">//type 事件类型； route 当前路由信息； model 当前表单信息，根据不同类型。表单相关的事件才会有值</span>
    <span class="hljs-attr">before</span>: <span class="hljs-function">(<span class="hljs-params">params, { type, route, model }</span>) =&gt;</span>
    {
      <span class="hljs-comment">// params请求的参数，可根据type作判断，对params作修改后return回去</span>
      <span class="hljs-comment">// 需要将params参数return</span>
...
}</code></pre>`,20),p=[l],h={__name:"list",setup(r){return(e,c)=>(s(),t("div",n,p))}};export{h as default};
