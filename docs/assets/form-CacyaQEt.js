/* empty css                                                            */import{o as s,c as t,ad as a}from"./index-BIFij2q2.js";const n={class:"marked-body"},l=a(`<h1 id="akform-表单">AKForm 表单</h1><p>适用于导出vue文件</p><h2 id="使用方式">使用方式</h2><pre class="language-html"><code class="hljs">
