...
<\/script>`;$(()=>{k.value=F(v,"editJsonCopy","html")})},f=t=>{var U,w,S,R;const l=((U=t.config)==null?void 0:U.openType)==="dialog",d=((w=t.config)==null?void 0:w.dialogWidth)||"600px",m=(S=t.config)==null?void 0:S.requestUrl;m&&delete t.config.requestUrl;const i=(R=t.config)==null?void 0:R.deleteUrl;i&&delete t.config.deleteUrl;let v="",g="",_="";l&&(_='@btn-click="listBtnClick"',v=`<el-dialog
      destroy-on-close
...
<script setup lang="ts">
  ...
  ${d}
<\/script>
${l}`;$(()=>{k.value=F(v,"editJsonCopy","html")})},o=t=>{$(()=>{const l=new he(t.target,{text:()=>k.value.getValue()});l.on("success",function(){G({message:"复制成功！",type:"success"}),l.destroy()}),l.on("error",function(){G.error("复制失败"),l.destroy()}),l.onClick(t)})},p=()=>{var i;const t="data:text/csv;charset=utf-8,"+((i=k.value)==null?void 0:i.getValue()),l=new Date().getTime()+".vue",d=encodeURI(t),m=document.createElement("a");m.setAttribute("href",d),m.setAttribute("download",l),m.click()};return D({open:u,openTable:f,openScreen:e}),(t,l)=>{const d=V("el-button"),m=V("el-dialog");return N(),W(m,{modelValue:b.value,"onUpdate:modelValue":l[0]||(l[0]=i=>b.value=i),title:"导出vue文件",class:"export-dialog",width:"80%"},{footer:T(()=>[B("div",_e,[J(d,{size:"small",type:"primary",onClick:o},{default:T(()=>[I(" 复制数据 ")]),_:1}),J(d,{type:"primary",size:"small",onClick:p},{default:T(()=>[I(" 导出代码 ")]),_:1})])]),default:T(()=>[be]),_:1},8,["modelValue"])}}});export{Se as _,we as a};
