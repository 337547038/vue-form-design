...
<\/script>`;D(()=>{d.editor=I(i,"editJsonCopy","html")})},b=o=>{d.visible=!0;const t=`<template>
...
<\/script>
`;D(()=>{d.editor=I(t,"editJsonCopy","html")})},_=o=>{D(()=>{const t=new Tt(o.target,{text:()=>d.editor.getValue()});t.on("success",function(){z({message:"\u590D\u5236\u6210\u529F\uFF01",type:"success"}),t.destroy()}),t.on("error",function(){z.error("\u590D\u5236\u5931\u8D25"),t.destroy()}),t.onClick(o)})},l=()=>{const o="data:text/csv;charset=utf-8,"+d.editor.getValue(),t=new Date().getTime()+".vue",i=encodeURI(o),a=document.createElement("a");a.setAttribute("href",i),a.setAttribute("download",t),a.click()};return F(L({},B(d)),{open:v,dialogExport:l,copyData:_,openTable:b})}},Ct=P("div",{id:"editJsonCopy"},null,-1),At={class:"dialog-footer"},Ot=$(" \u590D\u5236\u6570\u636E "),Rt=$(" \u5BFC\u51FA\u4EE3\u7801 ");function Lt(d,m,v,b,_,l){const o=N("el-button"),t=N("el-dialog");return A(),Y(t,{modelValue:d.visible,"onUpdate:modelValue":m[0]||(m[0]=i=>d.visible=i),title:"\u5BFC\u51FAvue\u6587\u4EF6","custom-class":"export-dialog",width:"80%"},{footer:w(()=>[P("div",At,[U(o,{size:"small",type:"primary",onClick:b.copyData},{default:w(()=>[Ot]),_:1},8,["onClick"]),U(o,{type:"primary",size:"small",onClick:b.dialogExport},{default:w(()=>[Rt]),_:1},8,["onClick"])])]),default:w(()=>[Ct]),_:1},8,["modelValue"])}var Mt=q(wt,[["render",Lt]]);export{I as a,$t as h,Mt as v};
