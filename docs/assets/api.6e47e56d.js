...
</code></pre><h3 id="24-\u6839\u636E-id-\u5220\u9664\u6279\u91CF\u5220\u9664" data-source-line="427"><a class="markdownIt-Anchor" href="#24-\u6839\u636E-id-\u5220\u9664\u6279\u91CF\u5220\u9664">#</a> 2.4 \u6839\u636E id \u5220\u9664/\u6279\u91CF\u5220\u9664</h3><p data-source-line="429">\u63A5\u53E3\u540D\u79F0\uFF1A/content/delete</p><p data-source-line="431">\u8BF7\u6C42\u7C7B\u578B\uFF1APOST</p><p data-source-line="433">\u8BF7\u6C42\u53C2\u6570\uFF1A</p><pre style="display:none;"></pre><pre class="hljs vuedoc__hljs language-json hljs--one-dark"><code>{
  <span class="hljs-attr">&quot;id&quot;</span>: <span class="hljs-number">1</span>,
  <span class="hljs-attr">&quot;formId&quot;</span>: <span class="hljs-number">1</span>
}
</code></pre><p data-source-line="441">\u6279\u91CF\u5220\u9664\u8BF7\u6C42\u53C2\u6570\uFF1A</p><pre style="display:none;"></pre><pre class="hljs vuedoc__hljs language-json hljs--one-dark"><code>{
  <span class="hljs-attr">&quot;id&quot;</span>: <span class="hljs-string">&quot;1,2,3&quot;</span>,
  <span class="hljs-attr">&quot;formId&quot;</span>: <span class="hljs-number">1</span>
}
</code></pre><p data-source-line="450">\u8FD4\u56DE\u7ED3\u679C\uFF1A</p><pre style="display:none;"></pre><pre class="hljs vuedoc__hljs language-json hljs--one-dark"><code>{
  <span class="hljs-attr">&quot;code&quot;</span>: <span class="hljs-number">200</span>,
  <span class="hljs-attr">&quot;data&quot;</span>: [],
  <span class="hljs-attr">&quot;message&quot;</span>: <span class="hljs-string">&quot;\u5220\u9664\u6210\u529F/\u5931\u8D25&quot;</span>
}
</code></pre><h2 id="3-\u53EF\u521B\u5EFA\u8868\u5355\u6570\u636E\u6E90" data-source-line="460"><a class="markdownIt-Anchor" href="#3-\u53EF\u521B\u5EFA\u8868\u5355\u6570\u636E\u6E90">#</a> 3. \u53EF\u521B\u5EFA\u8868\u5355\u6570\u636E\u6E90</h2><p data-source-line="462">\u63A5\u53E3\u540D\u79F0\uFF1A/dataSource</p><p data-source-line="464">\u8BF7\u6C42\u7C7B\u578B\uFF1APOST</p><p data-source-line="466">\u8BF7\u6C42\u53C2\u6570\uFF1A\u65E0</p><p data-source-line="468">\u8FD4\u56DE\u7ED3\u679C\uFF1A</p><pre style="display:none;"></pre><pre class="hljs vuedoc__hljs language-json hljs--one-dark"><code>{
  <span class="hljs-attr">&quot;code&quot;</span>: <span class="hljs-number">200</span>,
  <span class="hljs-attr">&quot;data&quot;</span>: [
    {
      <span class="hljs-attr">&quot;id&quot;</span>: <span class="hljs-number">1</span>,
...
</code></pre><h2 id="4-\u6839\u636Eid\u83B7\u53D6\u5F53\u524D\u6570\u636E\u6E90\u53EF\u7528\u5B57\u6BB5" data-source-line="484"><a class="markdownIt-Anchor" href="#4-\u6839\u636Eid\u83B7\u53D6\u5F53\u524D\u6570\u636E\u6E90\u53EF\u7528\u5B57\u6BB5">#</a> 4. \u6839\u636Eid\u83B7\u53D6\u5F53\u524D\u6570\u636E\u6E90\u53EF\u7528\u5B57\u6BB5</h2><p data-source-line="486">\u63A5\u53E3\u540D\u79F0\uFF1A/getField</p><p data-source-line="488">\u8BF7\u6C42\u7C7B\u578B\uFF1APOST</p><p data-source-line="490">\u8BF7\u6C42\u53C2\u6570\uFF1A</p><pre style="display:none;"></pre><pre class="hljs vuedoc__hljs language-json hljs--one-dark"><code>{
  <span class="hljs-attr">&quot;id&quot;</span>: <span class="hljs-string">&quot;1&quot;</span>
}
</code></pre><p data-source-line="498">\u8FD4\u56DE\u7ED3\u679C\uFF1A</p><pre style="display:none;"></pre><pre class="hljs vuedoc__hljs language-json hljs--one-dark"><code>{
  <span class="hljs-attr">&quot;code&quot;</span>: <span class="hljs-number">200</span>,
  <span class="hljs-attr">&quot;data&quot;</span>: [
    {
...
</code></pre><h2 id="5-\u56FE\u7247\u6587\u4EF6\u4E0A\u4F20" data-source-line="581"><a class="markdownIt-Anchor" href="#5-\u56FE\u7247\u6587\u4EF6\u4E0A\u4F20">#</a> 5. \u56FE\u7247/\u6587\u4EF6\u4E0A\u4F20</h2><p data-source-line="583">\u63A5\u53E3\u5730\u5740\u5982\uFF1A</p><p data-source-line="585">\u8BF7\u6C42\u7C7B\u578B\uFF1Apost</p><p data-source-line="587">\u8BF7\u6C42\u53C2\u6570\uFF1AformData\u6570\u636E</p><p data-source-line="589">\u8FD4\u56DE\u7ED3\u679C\uFF1A</p><pre style="display:none;"></pre><pre class="hljs vuedoc__hljs language-json hljs--one-dark"><code>{
  <span class="hljs-attr">&quot;code&quot;</span>: <span class="hljs-number">200</span>,
...
</code></pre>`,124),m=[g];function b(o,n,s,p,t,a){return d(),q("div",i,m)}const v=u(j,[["render",b]]);export{v as default};
