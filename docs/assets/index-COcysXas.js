/* empty css                                                            */import{c as e,o as s,af as o}from"./index-CYQNA_yI.js";const t={class:"marked-body"},d={__name:"index",setup(c){return(a,n)=>(s(),e("div",t,[...n[0]||(n[0]=[o(`<h1>开发指南</h1><p>欢迎有兴趣的同学参与完善文档</p><h2>目录结构</h2><pre class="language-text"><code class="hljs">nodejs 模拟后端接口
public
 ├─mock json模拟数据
 ├─static 静态资源
   ├─ iconfont icon图标
