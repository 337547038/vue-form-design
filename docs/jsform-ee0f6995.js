  ...
  <span class="hljs-attr">list</span>: [
    {
      ...
      <span class="hljs-attr">config</span>: <span class="hljs-comment">// 其他一些扩展配置信息</span>
        {
          <span class="hljs-attr">hidden</span>: <span class="hljs-string">&quot;$.name===1&quot;</span>, <span class="hljs-comment">// 联动表达式，即当表单中字段标识为\`name\`的控件值为\`1\`时，当前控件隐藏</span>
          <span class="hljs-attr">disabled</span>: <span class="hljs-string">&quot;$.name===1&quot;</span>, <span class="hljs-comment">// 联动表达式，即当表单中字段标识为\`name\`的控件值为\`1\`时，当前控件禁用</span>
          <span class="hljs-attr">disabledEdit</span>: <span class="hljs-literal">true</span> <span class="hljs-comment">// 编辑状态下禁用，即表单部分字段只能添加，不允许编辑时可使用此设置</span>
        },
      <span class="hljs-attr">customRules</span>: [], <span class="hljs-comment">// 使用快速方法添加的校验规则，会自动合并到\`item.rules\`</span>
      <span class="hljs-attr">formItem</span>:<span class="hljs-comment">// 组件el-form-item的参数配置</span>
        {
