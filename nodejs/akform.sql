...
CREATE TABLE `design` (
  ...
  `listData` text DEFAULT NULL COMMENT '主用于表格的搜索数据',
  ...
  `creatName` varchar(50) DEFAULT NULL COMMENT '创建的用户名称',
  `editName` varchar(50) DEFAULT NULL COMMENT '最后修改的用户名称',
...
(20, '表单分类', 'sys-form', 1, '方便管理所有创建的表单', '[{\"label\":\"表单\",\"value\":\"1\"},{\"label\":\"流程表单\",\"value\":\"2\"},{\"label\":\"分类3\",\"value\":\"3\"}]', '0000-00-00 00:00:00', 1),
(21, '启用状态', 'sys-status', 1, '', '[{\"label\":\"启用\",\"value\":\"1\"},{\"label\":\"禁用\",\"value\":\"0\"}]', '0000-00-00 00:00:00', 1),
(22, '数据源分类', 'sys-source', 1, '', '[{\"label\":\"表单\",\"value\":\"0\"},{\"label\":\"流程表单\",\"value\":\"1\"}]', '0000-00-00 00:00:00', 1),
(23, '列表分类', 'sys-list', 1, '方便管理列表', '[{\"label\":\"分类1\",\"value\":\"1\"},{\"label\":\"分类2\",\"value\":\"2\"}]', '0000-00-00 00:00:00', 1),
(25, '流程分类', 'sys-flow', 1, '', '[{\"label\":\"内外勤\",\"value\":\"1\"},{\"label\":\"财务\",\"value\":\"2\"},{\"label\":\"行政\",\"value\":\"3\"},{\"label\":\"其他\",\"value\":\"4\"}]', '0000-00-00 00:00:00', 1),
(26, '数据大屏分类', 'sys-screen', 1, '', '[{\"label\":\"大屏分类1\",\"value\":\"1\"}]', '0000-00-00 00:00:00', 1);
...
(17, 2, '列表页设计管理', 'icon-list', 2, '/design/list/list', 1, '', 1),
(18, 2, '数据统计图管理', 'icon-line', 4, '/design/echarts/list', 1, '', 1),
(19, 2, '数据大屏管理', 'icon-data', 8, '/design/screen/list', 1, '', 1),
...
(27, 1, '组件示例', 'icon-doc', 0, '/design/list/content/26', 1, '', 3),
(28, 1, '客户信息', 'icon-user', 0, '/design/list/content/28', 1, '', 3);
...
CREATE TABLE `user` (
  ...
  `phone` varchar(11) DEFAULT NULL,
  `status` int(1) NOT NULL,
  `role` varchar(50) DEFAULT NULL COMMENT '权限角色id',
