...
CREATE TABLE `form1` (
  ...
  `number` varchar(4) NOT NULL COMMENT '计数器',
...
INSERT INTO `form1` (`id`, `title`, `date`, `user`, `password`, `radio`, `checkbox`, `number`, `cascader`, `select1`, `textarea`, `switch`, `txt`, `upload`, `tableList`, `input1`, `input2`, `input3`, `input4`, `input5`, `input6`, `input7`, `input8`) VALUES
(2, '12', '2021-11-19', '', '', 'value2', '[\"label2\",\"label3\"]', '3', '[\"consistency\"]', 'value1', '25', '1', '纯文本', '', '[{\"input1\":\"1\",\"input2\":\"2\"}]', '', '', '3', '4', '5', '6', '7', '');
